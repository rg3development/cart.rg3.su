	...
	<div id="content">
		<form action="<?=base_url();?>admin/cart/edit/<?=$data['id']?>/<?=$parent_id;?>" method="post">
			<table class="admin_module_form cart_module_edit">
				...
				<tr><td class="admin_module_form_title">название</td><td><input type="cart" name="title" value='<?=$data['title'];?>' /></td></tr>
				...
				<tr><td class="admin_module_form_title">текст</td><td><cartarea id="description" name="description"><?=$data['description'];?></cartarea></td></tr>
				<tr>
